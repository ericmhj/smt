/**
 * PDF Legacy Service (Puppeteer)
 *
 * Preserved legacy implementation of PDF generation using Puppeteer.
 * Used as fallback when no report template is active for a reactivo's form_type.
 *
 * @module pdf-legacy.service
 * @requirements 8.3, 14.1, 14.4
 */
