...
export const clientes = pgTable(
  'clientes',
  {
    ...
    direccionCentroTrabajo: varchar('direccion_centro_trabajo', { length: 500 }).notNull(),
    actividadPrincipal: varchar('actividad_principal', { length: 255 }).notNull(),
    contacto: varchar('contacto', { length: 255 }).notNull(),
    horarios: varchar('horarios', { length: 255 }).notNull(),
